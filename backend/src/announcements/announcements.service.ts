  ...
  async create(userId: number, dto: AnnouncementDto) {
    return this.prisma.announcement.create({
      data: {
        ...
        fileData: dto.fileData ? dto.fileData : null,
        fileName: dto.fileName ? dto.fileName.trim() : null,
        fileType: dto.fileType ? dto.fileType : null,
  ...
  async update(id: number, userId: number, dto: AnnouncementDto) {
    ...
    return this.prisma.announcement.update({
      ...
      data: {
        ...
        ...(dto.fileData !== undefined ? { fileData: dto.fileData || null } : {}),
        ...(dto.fileName !== undefined ? { fileName: dto.fileName?.trim() || null } : {}),
        ...(dto.fileType !== undefined ? { fileType: dto.fileType || null } : {}),
