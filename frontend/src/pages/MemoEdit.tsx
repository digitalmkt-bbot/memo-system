  ...
  return (
    <>
      ...
      <MemoForm memoId={mid} status={data.memo.status} initial={{
        ...
        items: data.memo.items || [], vat: !!data.memo.vat, discount: data.memo.discount ?? '',
        expenseDate: data.memo.expenseDate ? String(data.memo.expenseDate).slice(0, 10) : '',
        backdateReason: data.memo.backdateReason || '',
        category: data.memo.category || 'general',
        categoryNote: data.memo.categoryNote || '',
