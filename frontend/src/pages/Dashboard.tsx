      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1fr_1.25fr] lg:auto-rows-min lg:grid-flow-row-dense">
        ...
        <div className="card p-6 lg:col-span-2">
          ...
          <div className="flex items-center mt-3">
            <div className="flex-[4] h-6 rounded-[10px] bg-gradient-to-r from-[#ededed] to-[#1a1a1a]" />
            <div className="w-px h-7 bg-slate-200 mx-3" />
            <div className="flex-1 h-6 rounded-[10px] bg-gradient-to-r from-[#eafff3] to-[#4ade80]" />
            <div className="w-px h-7 bg-slate-200 mx-3" />
            <div className="flex-1 h-6 rounded-[10px] bg-gradient-to-r from-[#fff0f7] to-[#ff6fb5]" />
          </div>
        </div>
