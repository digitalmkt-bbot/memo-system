...
const TH: Dict = {
  ...
  common: {
    ...
    systemFull: 'ระบบจัดการบันทึกข้อความภายใน',
    logout: 'ออกจากระบบ',
    search: 'ค้นหา',
    loading: 'กำลังโหลด…',
    save: 'บันทึก',
  ...
  login: {
    subtitle: 'ระบบจัดการบันทึกข้อความภายใน',
    email: 'อีเมล',
    password: 'รหัสผ่าน',
    signIn: 'เข้าสู่ระบบ',
  ...
  dashboard: {
    ...
    pending_manager: 'รออนุมัติขั้นแรก',
  ...
  form: {
    ...
    catGeneral: 'ขออนุมัติทั่วไป', catBudget: 'ขออนุมัติงบประมาณ', catAdvance: 'เบิกเงินสำรองจ่าย', catProcurement: 'ขอจัดซื้อ/จัดจ้าง', catSalary: 'เงินเดือน/ค่าจ้าง', catAllowance: 'เบี้ยเลี้ยง', catFuel: 'ค่าน้ำมัน', catIsland: 'ค่าลงเกาะ', catInfo: 'แจ้งเพื่อทราบ', catOther: 'อื่นๆ',
    selfManagerNote: 'คุณเป็นผู้จัดการแผนกนี้ — เมื่อส่งจะข้ามขั้นหัวหน้า ไปยัง:',
    from: 'ผู้ขอ *',
    fromPlaceholder: 'ชื่อผู้ขอ / หน่วยงาน',
    subject: 'เรื่อง *',
  ...
  create: {
    ...
    subtitle: 'เลขที่เอกสารจะออกอัตโนมัติเมื่อกดส่ง',
  },
  edit: {
    title: 'แก้ไขฉบับร่าง',
  },
  view: {
    ...
    attachAfterClose: 'ปิดงานแล้ว — แนบใบกำกับภาษี / บิล / ใบเสร็จเพิ่มได้ที่นี่',
    attachments: 'ไฟล์แนบ',
  ...
  items: {
    ...
    vatNote: 'ภาษีมูลค่าเพิ่มจะกำหนดตอนออกเอกสารจัดซื้อ', none: 'ยังไม่มีรายการ',
    vatLabel: 'คิดภาษีมูลค่าเพิ่ม 7%', subtotal: 'ยอดรวม', vatAmount: 'ภาษีมูลค่าเพิ่ม 7%', grandTotal: 'ยอดรวมสุทธิ',
  },
  sign: {
  ...
  status: {
    draft: 'ฉบับร่าง', pending_manager: 'รออนุมัติขั้นแรก', pending_executive: 'รอผู้บริหาร',
    pending_hrmd: 'รอบุคคล/กรรมการฯ', pending_fc: 'รอฝ่ายบัญชี',
...
const EN: Dict = {
  ...
  dashboard: {
    ...
    approved: 'Approved',
    pending_manager: 'Awaiting first approval',
  ...
  form: {
    ...
    catGeneral: 'General approval', catBudget: 'Budget approval', catAdvance: 'Advance / petty cash', catProcurement: 'Procurement', catSalary: 'Salary/Payroll', catAllowance: 'Allowance', catFuel: 'Fuel', catIsland: 'Island landing fee', catInfo: 'For information', catOther: 'Other',
    selfManagerNote: 'You are this department\'s manager — submitting skips the manager step and forwards to:',
    from: 'Requester *',
    fromPlaceholder: 'Requester name / unit',
    subject: 'Subject *',
  ...
  view: {
    ...
    attachAfterClose: 'Closed — you can attach tax invoice / bill / receipt here',
    ...
    stepHold: 'on hold',
    onHoldBadge: 'On hold',
    confirmHold: 'Confirm: hold for review',
    holdBtn: 'Hold',
    ...
    chooseNext: 'Forward to', toHrm: 'HR Manager (HRM)', toMd: 'Managing Director (MD)', finalizeNow: 'Approve now (finish)',
  ...
  status: {
    draft: 'Draft', pending_manager: 'Awaiting first approval', pending_executive: 'Awaiting executive',
