...
const TH: Dict = {
  ...
  form: {
    ...
    catGeneral: 'ขออนุมัติทั่วไป', catBudget: 'ขออนุมัติงบประมาณ', catProcurement: 'ขอจัดซื้อ/จัดจ้าง', catSalary: 'เงินเดือน/ค่าจ้าง', catInfo: 'แจ้งเพื่อทราบ', catOther: 'อื่นๆ',
...
const EN: Dict = {
  ...
  form: {
    ...
    catGeneral: 'General approval', catBudget: 'Budget approval', catProcurement: 'Procurement', catSalary: 'Salary/Payroll', catInfo: 'For information', catOther: 'Other',
